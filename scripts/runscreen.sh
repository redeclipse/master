...
#echo "opening dev server screen.."
#screen -S redeclipse -p 1 -X stuff '/bin/sh -l "${HOME}/master/scripts/runserver.sh" dev\n'

#echo "opening statistics database screen.."
#screen -S redeclipse -p 2 -X stuff '/bin/sh -l "${HOME}/master/scripts/runserver.sh" statsdb\n'
